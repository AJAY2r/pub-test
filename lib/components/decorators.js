...
var Toggle = function Toggle(_ref2) {
    ...
    var onClick = svgToggle ? props.onClick : '';
    var height = style.height,
        width = style.width;

    var midHeight = height * 0.5;
    var svgDisplay = node.hideArrow ? 'none' : '';
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(
                'svg',
                { height: height, width: width, display: svgDisplay },
...
var Container = (0, _radium2.default)(_class = function (_React$Component) {
    ...
    (0, _createClass3.default)(Container, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { onClick: !this.props.svgToggle ? onClick : '',
        ...
        value: function renderToggleDecorator() {
            ...
            return _react2.default.createElement(decorators.Toggle, { props: params });
        }
    }]);
    return Container;
