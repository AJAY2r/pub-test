...
var TreeNode = function (_React$Component) {
    ...
    (0, _createClass3.default)(TreeNode, [{
        ...
        value: function renderCheckbox() {
            var chkChecked = _lodash2.default.includes(this.props.checkedOptions, this.props.node[this.props.checkboxField]) || false;
        ...
        value: function render() {
            ...
            var nodeChecked = _lodash2.default.includes(this.props.nodeCheckedOptions, this.props.node[this.props.nodeSelectionField]) || false;
            var liClassTmp = nodeChecked && this.props.fillSelectedNode ? 'selected' : '';
            var lazyLoadNodeHeight = this.props.lazyLoadNodeHeight;
            var tmpHeight = 'auto';
            if (lazyLoadNodeHeight && (!this.props.node.children || this.props.node.children.length === 0)) {
                tmpHeight = lazyLoadNodeHeight;
            }
            var styleBase = _lodash2.default.cloneDeep(style.base);
            ...
            if (this.props.enableLazyLoading) {
                data = _react2.default.createElement(
                    ...
                    { height: tmpHeight, debounce: this.props.debounce, throttle: this.props.throttle },
            ...
            return _react2.default.createElement(
                ...
                children.map(function (child, index) {
                    return _react2.default.createElement(TreeNode, (0, _extends3.default)({}, _this4._eventBubbles(), {
                        ...
                        nodeCheckedOptions: _this4.props.nodeCheckedOptions,
                        nodeSelectionField: _this4.props.nodeSelectionField,
                        enableLazyLoading: _this4.props.enableLazyLoading,
                        lazyLoadNodeHeight: _this4.props.lazyLoadNodeHeight,
                        debounce: _this4.props.debounce,
                        throttle: _this4.props.throttle,
                        indexChildren: index }));
                })
            );
        }
