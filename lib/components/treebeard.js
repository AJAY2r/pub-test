            ...
            return _react2.default.createElement(
                ...
                data.map(function (node, index) {
                    return _react2.default.createElement(_node2.default, { animations: animations,
                        ...
                        enableCheckbox: _this2.props.enableCheckbox,
                        checkboxField: _this2.props.checkboxField,
                        handleCheckbox: _this2.props.handleCheckbox,
                        checkedOptions: _this2.props.checkedOptions,
                        svgToggle: _this2.props.svgToggle,
                        fillSelectedNode: _this2.props.fillSelectedNode,
                        nodeCheckedOptions: _this2.props.nodeCheckedOptions,
                        nodeSelectionField: _this2.props.nodeSelectionField,
                        enableLazyLoading: _this2.props.enableLazyLoading,
                        lazyLoadNodeHeight: _this2.props.lazyLoadNodeHeight,
                        debounce: _this2.props.debounce,
                        throttle: _this2.props.throttle });
                })
            );
        }
    }]);
...
TreeBeard.propTypes = {
    ...
    enableCheckbox: _propTypes2.default.bool,
    checkboxField: _propTypes2.default.string,
    checkedOptions: _propTypes2.default.array,
    handleCheckbox: _propTypes2.default.func,
    svgToggle: _propTypes2.default.bool,
    fillSelectedNode: _propTypes2.default.bool
};
